...
<div class="message-reporting">
	<h2><?php _e('Register and Create your product','wpstamp') ?></h2>
</div>
<?php }else{?>
...
<div data-height="<?php echo $height_pixels ?>" data-width="<?php echo $width_pixels ?>" class="designer-container">
				...
				<div class="moving-tools" id="moving-tools">
									<nav>
										...
										<div class="material-toolbox hidden">
											<a class="fa-button bring-to-front" title="<?php _e('Bring to Front','wpstamp'); ?>"><em class="material-icons">keyboard_arrow_up</em></a>
											<a class="fa-button send-to-back" title="<?php _e('Send to Back','wpstamp'); ?>"><em class="material-icons">keyboard_arrow_down</em></a>
											<a class="fa-button remove-selected" title="<?php _e('Delete selected item','wpstamp'); ?>"><em class="material-icons">delete</em> </a>
											<a class="fa-button" id="crop" title="<?php _e('Crop and change selected item','wpstamp'); ?>"><em class="material-icons">exposure</em> </a>
										</div>
	...
	<nav class="outter-tools">
		<a id="flip" data-original="back" class="fa-button flipp"><em class="material-icons">rotate_right</em><?php _e('Flip','wpstamp'); ?></a>
		<a href="#layers" title="<?php _e('Show Layers','wpstamp'); ?>" class="fa-button" id="layer-trigger"><em class="material-icons">layers</em></a>
			...
			<div class="tools">
					<div class="fa-widget base-top">
						<div class="price hidden">
							...
							<h1 data-collapse="backgrounds" class="widget-title"><em class="material-icons">format_shapes</em><a href="#"><?php _e('Product Variations','wpstamp');?></a></h1>
								<h1 data-collapse="paint-tools" class="widget-title"><em class="material-icons">format_paint</em><a href="#"><?php _e('Painter','wpstamp');?></a></h1>
							
			<h1 data-collapse="gallery" class="widget-title"><em class="material-icons">image</em><a href="#"><?php _e('Images and Vectors','wpstamp'); ?></a></h1>
			<h1 data-collapse="my-gallery" class="widget-title"><em class="material-icons">face</em><a href="#"><?php _e('Your Images','wpstamp'); ?></a></h1>
			<h1 data-collapse="text-tool" class="widget-title"><em class="material-icons">text_fields</em><a href="#"><?php _e('Text','wpstamp'); ?></a></h1>											<h1 class="widget-title" data-collapse="product-changer"><em class="material-icons">list</em><a href=""><?php _e('Change Product','wpstamp'); ?></a></h1>
				...
				<?php if(get_option('FA_FreedrawTool')=='on' || get_option('FA_ShapeTool')=='on'){ ?>
								...
								<ul class="static painters" id="paint-tools">
									<li class="heading"><h2>Change Values</h2></li>
										<ul class="geometry-tools">
											...
											<li>	<a title="<?php _e('Free Draw','wpstamp') ?>"  class="fa-button freedraw"> <em class="material-icons">brush</em></a> </li>
											<?php } ?>
												<?php if(get_option('FA_ShapeTool')=='on'){ ?>	
													<li><a title="<?php _e('Rentacle','wpstamp') ?>" class="fa-button rect"> <em class="material-icons">crop_din</em></a> </li>
														<li><a title="<?php _e('Circle','wpstamp') ?>" class="fa-button circle"> <em class="material-icons">lens</em></a> </li>
														<li><a title="<?php _e('Triangle','wpstamp') ?>" class="fa-button triangle"> <em class="material-icons">network_cell</em></a> </li>
														<li><span title="<?php _e('Polygon','wpstamp') ?>" class="fa-button poly">
						...
						<?php if(get_option('FA_GalleryTool')=='on'){?>
									...
									<ul class="static overflow" id="gallery">
										...
										<ul class="photo-list"><li class="nothing"><?php _e('Choose a category','wpstamp'); ?></li></ul>
						...
						<?php if(get_option('FA_GalleryTool')=='on'){?>
									...
									<ul class="static overflow" id="my-gallery">
										...
										<ul class="selection-user-list"><li class="nothing">	<a class="fa-button upload primary"><em class="material-icons">file_upload</em><?php _e('Upload Your Images','wpstamp'); ?>
												...
												<a id="user-library" class="fa-button social library"><em class="material-icons">photo_library</em>My Library</a>
												</li></ul>
										

											<ul class="upload-nav hidden">
													<li class="center"><a id="return" href="#"><em class="material-icons">arrow_back</em><?php _e('Return','wpstamp'); ?></a>
												</li>
						...
						<?php if(get_option('FA_TextTool')=='on'){ ?>
								...
								<ul class="static" id="text-tool">
									...
									<li>
										<div class="text-area">
											<textarea class="gn-text" id="text-string" type="text" placeholder="<?php _e('add text here...','wpstamp'); ?>"></textarea>
											<a id="add-text" class="fa-button solid add-button"><em class="material-icons">insert_comment</em><?php _e('Add text','wpstamp'); ?></a>		<a data-collapse="convert-curve" data-type="arc" class="fa-button arc convert solid"><em class="material-icons">donut_large</em>Arc</a>
								
										</div>
															
							
									<div class="toolbox padded hide" id="convert-curve">
											<small>Reverse</small> <div class="slider" id="reverse"></div>
											<small>Radius</small> <div class="slider" id="radius"></div>
											<small>Spacing </small> <div class="slider" id="spacing"></div>
									</div>	
									</li>
...
<?php
    ...
    <span class="pricing"><?php echo $price_html; ?></span>
								...
								<em class="material-icons">shopping_cart</em><?php  if($edit==1){ _e('Update Product', 'wpstamp'); }else{ _e('Create Product', 'wpstamp'); }?></a>
