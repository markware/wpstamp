...
function() {
    ...
    Darkroom.UI = {
        ...
        createButton: function(options) {
            ...
            buttonElement.type = "button", buttonElement.className = "darkroom-button darkroom-button-" + options.type, buttonElement.innerHTML = '<em class="material-icons">' + options.image + '</em>', this.element.appendChild(buttonElement);
